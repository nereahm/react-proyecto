            ...
            {tresUltimos.map(perro => (
                <div key={perro.id_animal} className='seccionCardsInicio__card'>
                    <img
                        ...
                        src={"https://express-proyecto.vercel.app/" + perro.imagen} alt={perro.nombre}
                    />
                    <h2 className='seccionCardsInicio__titulo'>{perro.nombre}</h2>
                    <p className='seccionCardsInicio__datos'>Raza: {perro.raza}&nbsp;&nbsp;Edad: {perro.edad} años&nbsp;&nbsp;Género: {perro.genero}</p>
